...
const { listarPacientes, obtenerPaciente } = require('../controllers/pacienteController');
...
const { crearReceta, recetasPorHistoria } = require('../controllers/recetaController');
...
// ─── ADMISIONES ───────────────────────────────────────────────────────────────
router.post('/admisiones', authMiddleware(['Admin', 'Enfermero']), registrarIngreso);
